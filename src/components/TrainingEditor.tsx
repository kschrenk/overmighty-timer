...
const TrainingEditor: React.FC = () => {
  ...
  const handleSetChange = (id: string, field: keyof Set, value: number | string) => {
    if (!editingSession) return;
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="mb-4 flex justify-between items-center">
        <h3 className="text-lg font-medium text-gray-800">Sets</h3>
        <button
          ...
          {editingSession.sets.map((set, index) => (
            ...
            >
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    title={editingSession.sets.length === 1 ? "Can't delete the only set" : "Delete set"}
                  >
                    <Trash2 size={18} />
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor={`gripType-${set.id}`} className="block text-sm font-medium text-gray-700 mb-1">
                    Grip Type
                  </label>
                  <input
                    type="text"
                    id={`gripType-${set.id}`}
                    value={set.gripType}
                    onChange={(e) => handleSetChange(set.id, 'gripType', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                
                <div>
                  <label htmlFor={`hangTime-${set.id}`} className="block text-sm font-medium text-gray-700 mb-1">
                    Hang Time (seconds)
                  </label>
                  <input
                    type="number"
                    ...
                    min="1"
                    max="60"
                    onChange={(e) => handleSetChange(set.id, 'hangTime', parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                
                <div>
                  <label htmlFor={`repetitions-${set.id}`} className="block text-sm font-medium text-gray-700 mb-1">
                    Repetitions
                  </label>
                  <input
                    type="number"
                    ...
                    min="1"
                    max="20"
                    onChange={(e) => handleSetChange(set.id, 'repetitions', parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                
                <div>
                  <label htmlFor={`restAfter-${set.id}`} className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    ...
                    min="0"
                    max="300"
                    onChange={(e) => handleSetChange(set.id, 'restAfter', parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                
                <div>
                  <label htmlFor={`additionalWeight-${set.id}`} className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    ...
                    min="0"
                    max="100"
                    onChange={(e) => handleSetChange(set.id, 'additionalWeight', parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
              </div>
